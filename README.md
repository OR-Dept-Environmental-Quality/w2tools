...
sim1_start_year <- 2016

# Read all TSR outputs
tsr_sim1_raw <- w2_read_tsr_all(dir = sim1_dir, 
                                sim_name = sim1_name, 
                                year = sim1_start_year)
                            
                  
# Extract datetime and temperature output columns and pivot into wide format 
...
# Calculate 7dadm for the temperature output and pivot into wide format 
# where rows = datetime and column headers = segments
# Note calc_7dadm function comes from DEQ's heatsourcetools R pacakge found on 
# DEQ's GitHub respository https://github.com/OR-Dept-Environmental-Quality/heatsourcetools
